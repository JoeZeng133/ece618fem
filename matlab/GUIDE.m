...
% Last Modified by GUIDE v2.5 08-Apr-2018 19:00:35
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    x = char(get(handles.edit1,'String')); %Width
    a = str2double(x);
    y = char(get(handles.edit2,'String')); %Height
    b = str2double(y);
    z = char(get(handles.edit3,'String')); %meshsize
